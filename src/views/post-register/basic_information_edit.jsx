...
export default function BasicInformationEdit() {
  ...
  const onFinish = async (values) => {
    const updatedFileList = imageAlbum.map((obj) => {
      return obj.originFileObj  ? obj.originFileObj : obj;
    });
  ...
  return (
    <div className="basic_information_edit">
      <Form {...formItemLayout} form={form} onFinish={onFinish}>
        ...
        >
          ...
          >
            {apartFilter.map((apart) => (
              <Select.Option key={apart.value} value={apart.value}>
                {apart.name}
              </Select.Option>
            ))}
          </Select>
        ...
        <Form.Item name="latitude" label="Kinh độ" initialValue={coordinates.lat} hidden></Form.Item>
        <Form.Item name="longitude" label="Vĩ độ" initialValue={coordinates.lon} hidden></Form.Item>
        <Form.Item
          wrapperCol={{
            span: 12,
            offset: 10,
